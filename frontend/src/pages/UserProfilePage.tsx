...
// ── Mastery (Phase 1 — Skill & Mastery Engine) ────────────────────────────────
...
function MasterySection() {
  ...
  if (isLoading) {
    return (
      <div className="bg-breach-surface border border-breach-border rounded-xl p-4">
        <h2 className="text-xs font-bold text-breach-muted uppercase tracking-widest mb-3">Skill &amp; Mastery</h2>
  ...
  return (
    <div className="bg-breach-surface border border-breach-border rounded-xl p-4">
      <h2 className="text-xs font-bold text-breach-muted uppercase tracking-widest mb-1">Skill &amp; Mastery</h2>
